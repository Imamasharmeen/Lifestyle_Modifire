...
export default function Navbar() {
  return (
    <nav className="w-full bg-white dark:bg-gray-900  sticky top-0 z-50">
      <div className=" mx-auto px-4 py-6 flex items-center justify-between border border-gray-200 dark:border-gray-700">
        {/* Logo */}
        <div className=" w-1/3 flex items-center gap-3">
          <Image src="/logo.png" alt="Logo" width={60} height={60} />
          
          <div className="leading-tight">
            <h1 className="text-red-500 dark:text-red-500 font-bold text-lg">
              MD ABDUL KAIYUM
            </h1>
